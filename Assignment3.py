...
def parse_args():
    ...
    parser.add_argument('-o', '--output', nargs = 1, default=["alignment.fasta"], type=str, help="Name of the Output file. Defaults to alignment.fasta. If the file already exists an error will be thrown.")
